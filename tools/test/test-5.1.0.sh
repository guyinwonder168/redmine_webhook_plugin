...
REDMINE_DIR="${REDMINE_DIR:-${PLUGIN_ROOT}/.redmine-test/redmine-5.1.0}"
PLUGIN_DIR="${PLUGIN_DIR:-${PLUGIN_ROOT}}"
BUNDLE_DIR="${BUNDLE_DIR:-${PLUGIN_ROOT}/.bundle-cache/5.1.0}"
IMAGE="redmine-dev:5.1.0"
LOG_DIR="${PLUGIN_ROOT}/logs"
LOG_FILE="${LOG_DIR}/run-test-5.1.0.log"
ESC=$'\033'
